...
namespace Swagger
{
    ...
    public static partial class APIV1Extensions
    {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task IdentityGetAsync(this IAPIV1 operations, CancellationToken cancellationToken = default(CancellationToken))
            {
                (await operations.IdentityGetWithHttpMessagesAsync(null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
